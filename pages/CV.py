...
if 'id' not in st.session_state:
    ...
    def upload_devpar_file(uploaded_file, uploaded_files):
        ...
        utils_gen_UI.upload_single_file_to_folder(uploaded_file, session_path) # Save the simulation setup file
        utils_gen_UI.upload_multiple_files_to_folder(uploaded_files, session_path) # Save the layer parameter files
