...
if 'id' not in st.session_state:
    ...
    # Start building the UI for the actual page
        ...
        with container_impedance_par.container():
            @st.fragment # Fragment for Impedance parameters, this will not automatically reload the page
            def fragment_Impedance_pars():
        ...
        with layer_container_impedance.container():
            ...
            @st.fragment # Fragment for Impedance device, this will not automatically reload the page
            def fragment_Impedance_device():
