...
if 'id' not in st.session_state:
    ...
    # Start building the UI for the actual page
        ...
        with container_transient_par.container():
            @st.fragment # Fragment for Transient JV parameters, this will not automatically reload the page
            def fragment_Transient_pars():
        ...
        with layer_container_transient_JV.container():
            ...
            @st.fragment # Fragment for Transient device, this will not automatically reload the page
            def fragment_Transient_device():
