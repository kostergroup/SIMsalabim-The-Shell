...
st.session_state['def_pagename'] = 'Hysteresis JV'
...
if 'id' not in st.session_state:
 ...
 # Init the rms error parameter
    ...
    # Objects to hold device parameters and hysteresis specific parameters (with defaults)
    dev_par = {}
    ...
    layer_container_hysteresis_JV = st.empty()
    ...
    def run_Hysteresis_JV():
        ...
        if result == 1:
            ...
            if result == 0 or result == 95:
                ...
                st.session_state['expObject'] = hyst_par_obj
    ...
    def upload_expJV_files(uploaded_files):
    ...
    def uploadFileDialog():
        ...
        if st.button("Submit", disabled = not allFilesUploaded):
            ...
            if (uploadedFile != None and uploadedFile != False) or (uploadedFiles != None and uploadedFiles != False):
                if uploadChoice == 'Experimental JVs':
                    upload_expJV_files(uploadedFiles)
    ...
    # Start building the UI for the actual page
        ...
        with container_hysteresis_par.container():
            ...
            for hyst_item in hyst_par:
                ...
                with col_val_hyst:
                    ...
                    elif hyst_item[0] == 'Vmin' or hyst_item[0] == 'Vmax' or hyst_item[0] == 'G_frac':
        ...
        with layer_container_hysteresis_JV.container():
            # Device layer setup        
